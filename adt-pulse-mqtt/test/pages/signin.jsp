...
<script type="text/javascript" src="/myhome/22.0.0-233/icjs/js-access_en_US.js"></script>   
    ...
    <div class="signin">
        <div class="content">
            <form action="signin.jsp" method="post" name="theform" id="theform" onsubmit="return doValidation();">
            
                <br />
                <div class="PageTitleText">Please Sign In</div>
                ...
                <tr id="unsupported_warning_row">
                    <td align="center">
                        <div class="browserWarning">
                            ...
                            We recommend using a <a href="supportedBrowsers.jsp">supported configuration</a>.
                        </div>
                        <br />
                    </td>
                </tr>
                
                <tr id="warnMsgContainer" style="display:none;">
                    <td align="center">
                        <div id="warnMsgContents" class="p_signinWarning"></div>
                        <br /><br />
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <table align="center" border="0" cellpadding="3" cellspacing="0">
                            <tr>
                                ...
                                <tr>
                                    <td height="22" align="right"><span class="InputFieldDescription">Password:</span></td>
                                    <td height="22"><input id="password" name="passwordForm" type="password" class="responsiveFormInput" size="30" maxlength="300" AUTOCOMPLETE="off" autocorrect="off" autocapitalize="off" spellcheck="false"><br/></td>
                                </tr>
                                
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="left"><input class="InputFieldShiftRight" type="checkbox" id="sun" name="sun" value="yes" /><label for="sun">Remember my username</label></td>
                                </tr>
                ...
                <tr>
                    <td align="center" valign="middle" height="50">
                        <input type="submit" id="signin" name="signin" value="Sign In" alt="Sign In" class="p_btn p_smtBtnMnormal" onclick="" onmouseover="javascript:btnHover(this,'M')" onmouseout="javascript:btnNormal(this,'M')" onmousedown="javascript:btnDown(this,'M')" onmouseup="javascript:btnNormal(this,'M')"  data-fitLabel="shrink"/><style type="text/css">#testSizesignin {position: absolute; visibility: hidden; height: auto; width: auto; white-space: nowrap; min-width: 0}</style><div id="testSizesignin" class="p_btn p_smtBtnMnormal" >Sign In</div>
                    </td>
                </tr>
